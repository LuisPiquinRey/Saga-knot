...
export default function Products() {
    return (
        <div id="menu-products-block">
            ...
            <div className="collection-buttons" style={{ marginBlockStart: "20px" }}>
            ...
            <div id="products">
                ...
                <ProductItem
                    ...
                    description={
                        "Elegant timepiece with leather strap and sapphire crystal"
                    }
                    price={189.0}
                    rating={4.8}
                />
                ...
                <ProductItem
                    ...
                    description={
                        "Lightweight cushioning for maximum comfort and performance"
                    }
                    price={129.99}
                    rating={4.7}
                />
                ...
                <ProductItem
                    ...
                    description={
                        "RGB backlit with tactile switches for gaming and typing"
                    }
                    price={149.99}
                    rating={4.9}
                />
