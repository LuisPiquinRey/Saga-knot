    ...
    public ResponseEntity<String> createProduct(@RequestBody @Valid ProductDto productDto) {
        try {
            CreateProductCommand command = CreateProductCommand.builder()
                    ...
                    .brand(productDto.idBrand() != null ? new Brand(productDto.idBrand(), null) : null)
                    .categories(productDto.categoryIds() != null
                            ? productDto.categoryIds().stream()
